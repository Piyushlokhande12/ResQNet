...
// const { sendSOSEmail } = require("../services/email.service");
...
//   try {
//     const { emergencyType, coordinates, description, triggerMethod } =
//       req.body;

//     const [lng, lat] = coordinates; // GeoJSON format [lng, lat]
...
//     // Notify emergency contacts via EMAIL only
...
//     // Real-time alert to admin/responder dashboard
//     const io = getIO();
...
//       type: "sos_alert",
//       title: "SOS Triggered",
//       body: "Your SOS has been sent. Emergency services have been notified.",
//       channel: "in_app",
//     });
...
// // ─── Get all incidents (Admin/Responder) ──────────────────────────────────────
